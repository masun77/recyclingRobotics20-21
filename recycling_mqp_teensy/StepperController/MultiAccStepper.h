//// MultiStepper.h
//
//#ifndef MultiAccStepper_h
//#define MultiAccStepper_h
//
//#include <stdlib.h>
//#if ARDUINO >= 100
//#include <Arduino.h>
...
//#endif
//
//#define MULTIACCSTEPPER_MAX_STEPPERS 10
//
//class AccelStepper;
//
///////////////////////////////////////////////////////////////////////
...
//    /// There is an upper limit of MULTIACCSTEPPER_MAX_STEPPERS = 10 to the number of steppers that can be managed
...
//
//    /// Set the target positions of all managed steppers to the same position.
//    /// \param[in] absolute An absolute stepper position. 
//    void moveTo(long absolute);
//
//    void move(long relative);
//    
//    /// Calls run() on all the managed steppers
...
//    AccelStepper* _steppers[MULTIACCSTEPPER_MAX_STEPPERS];
//
