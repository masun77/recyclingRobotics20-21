...
## [MQP] Augmenting images
If you want to augment the labeled images, you can run augment.py on the Annotations-export.csv (or whatever the name is).
This saves copies of each image reflected vertically/horizontally and rotated 90/180/270 degrees, and adds
annotations corresponding to those reflected/rotated images to a .csv file of your choice based on
