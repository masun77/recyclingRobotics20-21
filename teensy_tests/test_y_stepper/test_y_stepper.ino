/*
 * This file tests the to make sure the y steppers are working properly.
 * The cart will travel back and forth between the 0 and 400 steps positions.
 * The serial monitor will print out the current position and distance to go.
 * Instructions: position the cart in the approximate middle of the y-axis
 */
